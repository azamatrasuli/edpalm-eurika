export function EscalationBanner({ active = false, reason = '' }) {
  ...
  return (
    <div className="escalation-enter flex items-start gap-3 px-4 py-3 mx-3 sm:mx-5 mt-1 rounded-xl bg-escalation text-escalation-fg border border-escalation-border text-sm leading-normal shrink-0">
